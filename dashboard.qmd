...
gt_table <- Pschoolvo1 |> 
  ...
  tab_header(
    title = md("**That's My Song**"),
    subtitle = md("*A curated collection of tracks I love*")
  ) |>
  tab_footnote(
  ...
  tab_source_note(
    source_note = md("**Source:** [Spotify Playlist](https://api.spotify.com/v1/playlists/1zg2vh7uktbMz8zXmYPmbQ)")
  )
```
