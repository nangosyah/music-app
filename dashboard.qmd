...
# ================= NEW LAYOUT (MATCHES THE PICTURE) =================

## Column {width="30%"}  <!-- SMALL LEFT COLUMN -->
...
## Column {width="70%"}  <!-- BIG RIGHT COLUMN -->
...
<div style="
  ...
  font-size: 0.9rem;
">
Dashboard was inspired by **Melissa Van Bussel’s** Posit 2024 Table Contest tutorial.
</div>
:::
